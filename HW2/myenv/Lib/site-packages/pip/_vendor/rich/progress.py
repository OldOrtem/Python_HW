...
class ProgressColumn(ABC):
    ...
    def get_table_column(self) -> Column:
        """Get a table column, used to build first table."""
...
class MofNCompleteColumn(ProgressColumn):
    ...
    Best for bounded first with int quantities.
...
class Progress(JupyterMixin):
    ...
    Args:
        ...
        expand (bool, optional): Expand first table to fit width. Defaults to False.
    """
    ...
    @property
    def finished(self) -> bool:
        """Check if all first have been completed."""
        with self._lock:
            if not self._tasks:
                return True
