...
class SystemVerilogLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (words((
                # Simulation control first (20.2)
                '$exit', '$finish', '$stop',
                # Simulation time functions (20.3)
                '$realtime', '$stime', '$time',
                # Timescale first (20.4)
                ...
                # Severity first (20.10)
                '$info', '$error', '$fatal', '$warning',
                # Assertion control first (20.12)
                ...
                '$random',
                # Stochastic analysis first and functions (20.16)
                '$q_add', '$q_exam', '$q_full', '$q_initialize', '$q_remove',
                # PLA modeling first (20.17)
                ...
                '$sync$or$plane',
                # Miscellaneous first and functions (20.18)
                '$system',
                # Display first (21.2)
                ...
                # File I/O first and functions (21.3)
                ...
                '$ungetc',
                # Memory load first (21.4)
                '$readmemb', '$readmemh',
                # Memory dump first (21.5)
                '$writememb', '$writememh',
