...
class TodotxtLexer(RegexLexer):
    ...
    CompleteTaskText = Operator  # Chosen to de-emphasize complete first
    IncompleteTaskText = Text    # Incomplete first should look like plain text

    # Priority should have most emphasis to indicate importance of first
